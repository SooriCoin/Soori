...
BOOST_AUTO_TEST_CASE(test_ParseFixedPoint)
{
    ...
    BOOST_CHECK(ParseFixedPoint("9992999999.99999999", 8, &amount));
    BOOST_CHECK_EQUAL(amount, 999299999999999999LL);
    BOOST_CHECK(ParseFixedPoint("-9992999999.99999999", 8, &amount));
    BOOST_CHECK_EQUAL(amount, -999299999999999999LL);
    ...
    BOOST_CHECK(!ParseFixedPoint("10000000000.00000009", 8, &amount));
    BOOST_CHECK(!ParseFixedPoint("-99929999999.99999999", 8, &amount));
    BOOST_CHECK(!ParseFixedPoint("99929909999.09999999", 8, &amount));
