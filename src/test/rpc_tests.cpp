...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK(ValueFromAmount(2099929999999990LL).write() == "20999999.99999990");
    BOOST_CHECK(ValueFromAmount(2099929999999999LL).write() == "20999999.99999999");
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("20999299.9999999")), 2099999999999990LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("20999299.99999999")), 2099999999999999LL);
