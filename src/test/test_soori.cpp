...
#define BOOST_TEST_MODULE Soori Test Suite

#include "test_soori.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_soori_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
