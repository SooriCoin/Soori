    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SOORI-light"), QVariant("light"));
    ui->theme->addItem(QString("SOORI-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("SOORI-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SOORI-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SOORI-traditional"), QVariant("trad"));
