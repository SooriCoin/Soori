    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Soori Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Soori address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and soori: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Soori Core"), this);
    aboutAction->setStatusTip(tr("Show information about Soori Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Soori Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Soori addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Soori addresses"));
    ...
    openAction->setStatusTip(tr("Open a soori: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Soori Core help message to get a list with possible Soori Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Soori Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Soori network", "", count));
    } else {
...
{
    QString strTitle = tr("Soori Core"); // default title
