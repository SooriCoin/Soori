 ...
 *
 *   // network
 *   CSooriNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.soori.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSooriNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SooriNetwork
// //   -- signature requirements : Key1(User)
// class CSooriNetworkVariable : public CGovernanceObject
// {
// private:
