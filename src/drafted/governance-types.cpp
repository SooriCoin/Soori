...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SooriNetwork") type = SooriNetwork;
    if(strType == "SooriNetworkVariable") type = SooriNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SooriNetwork) s = "SooriNetwork";
    if(type == SooriNetworkVariable) s = "SooriNetworkVariable";
