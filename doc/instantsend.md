...
This mechanism has been integrated into Bitcore-Node-Soori which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/sooripay/insight-api-soori#web-socket-api](https://github.com/sooripay/insight-api-soori#web-socket-api)
* API: [https://github.com/sooripay/insight-api-soori#instantsend-transactions](https://github.com/sooripay/insight-api-soori#instantsend-transactions)
...
By default, the Soori Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Soori Core daemon:
