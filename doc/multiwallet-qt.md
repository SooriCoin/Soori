...
Only requiring some minor changes is soori.cpp.
...
Changes to soori.cpp
----------------------
soori.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
